...
1. [Stable Diffusion WebUI Forge](https://github.com/lllyasviel/stable-diffusion-webui-forge) で生成したグリッド画像のメタデータ（Parameters）をコピーする
2. `index.html` をブラウザで開く
3. 「整形前のメタデータ (Raw Parameters)」欄に貼り付ける
4. 自動で変換される。必要に応じて「変換」ボタンを押す
5. 抽出された Template / Negative Template を「コピー」ボタンで取得する
